...
| ------- | -------- | -------- | ------ | ----- | -------- | ----- |
| 20171002495 | 2021/xx/xx  | 单层BiLSTM | 2e-5 | 16 | 79.69 | 自己重写的师兄的代码 |

| 本科学号 | 测试时间 | model_architecture  | l_rate | batch | test_F1  | 说明 | 
| ------- | -------- | -------- | ------ | ----- | -------- | ----- |
| 20171003600 | 2021/xx/xx  | 单层BiLSTM | 2e-5 | 16 | 79.69 | 自己重写的师兄的代码 |

| 本科学号 | 测试时间 | model_architecture  | l_rate | batch | test_F1  | 说明 | 
| ------- | -------- | -------- | ------ | ----- | -------- | ----- |
| 17271137 | 2021/xx/xx  | 单层BiLSTM | 2e-5 | 16 | 79.69 | 自己重写的师兄的代码 |

| 本科学号 | 测试时间 | model_architecture  | l_rate | batch | test_F1  | 说明 | 
| ------- | -------- | -------- | ------ | ----- | -------- | ----- |
| 170219 | 2021/xx/xx  | 单层BiLSTM | 2e-5 | 16 | xx.xx | 自己重写的师兄的代码 |
...
| 本科学号 | 测试时间 | model_architecture  | l_rate | batch | test_F1  | 说明 | 
| ------- | -------- | -------- | ------ | ----- | -------- | ----- |
| 17190019 | 2021/xx/xx  | 单层BiLSTM | 2e-5 | 16 | xx.xx | 自己重写的师兄的代码 |

| 本科学号 | 测试时间 | model_architecture  | l_rate | batch | test_F1  | 说明 | 
| ------- | -------- | -------- | ------ | ----- | -------- | ----- |
| 1707020318 | 2021/xx/xx  | 单层BiLSTM | 2e-5 | 16 | xx.xx | 自己重写的师兄的代码 |
...
| 本科学号 | 测试时间 | model_architecture  | l_rate | batch | test_F1  | 说明 | 
| ------- | -------- | -------- | ------ | ----- | -------- | ----- |
| 17231190 | 2021/xx/xx  | 单层BiLSTM | 2e-5 | 16 | xx.xx | 自己重写的师兄的代码 |
