...
| 本科学号 | 测试时间 | 模型架构  | 学习率 | batch | test F1  | 说明 | 
| ------- | --------| -------- | ------ | ----- | -------- | ----- |
| 2017061904 | 2021/xx/xx  | 1-layer Bi-LSTM| 0.002| 16 | xx.xx | 使用了医药领域的训练数据进行了多任务训练，训练方式是将医药领域和MSRA的训练集混合，验证集和测试集都使用的是MSRA的|
| 2017061904 | 2021/xx/xx  | 1-layer Bi-LSTM| 0.002| 16 | xx.xx | 在上一版本的基础上，用MSRA的数据集又单独进行了微调，然后再进行测试|
